...
<BigValue data={market_summary} value=avg_daily_return title="Avg Daily Return %" fmt="+0.000%" />
...
<BigValue data={best} value=return_52w_pct title="Best Performer (52W)" fmt="+0.0%" />
<BigValue data={worst} value=return_52w_pct title="Worst Performer (52W)" fmt="+0.0%" />
...
<DataTable data={latest} rows=10>
    ...
    <Column id=daily_return_pct title="Daily Ret %" fmt="+0.00%" contentType=delta />
...
<DataTable data={sector}>
    ...
    <Column id=avg_daily_return_pct title="Avg Daily Ret %" fmt="+0.000%" contentType=delta />
    <Column id=avg_volatility_20d_pct title="Avg Vol %" fmt="0.0%" />
    <Column id=avg_pct_above_200sma title="% Above 200D SMA" fmt="+0.0%" />
</DataTable>
